...
def articulos(request): 
    ...
    if request.method != "POST":
        ...
        if formulario.is_valid():
            informacion = formulario.cleaned_data
            articulo = Articulo(titulo = informacion['titulo'],
...
def comentarios(request): 
    ...
    if request.method != "POST":
        ...
        if formulario.is_valid():
            informacion = formulario.cleaned_data
            articulo = Comentario(comentario = informacion['comentario'],
...
def respuestaBuscar(request): 
    ...
    if request.GET["nombre"]:
        ...
        return render(request,"respuesta_busqueda.html",{"respuesta":respuesta,"titulo":titulo}) 
